...
Call log:
  - waiting for locator('#input-email')
    - waiting for" https://tutorialsninja.com/demo/index.php?route=product/search&search=MacBook" navigation to finish...
    - navigated to "https://tutorialsninja.com/demo/index.php?route=product/search&search=MacBook"
